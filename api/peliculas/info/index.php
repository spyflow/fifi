...
$id = isset($_GET['title']) ? normalizeSearchQuery($_GET['title']) : '';
...
// Check cache first
$cacheKey = 'info_' . $tipo . '_' . md5($id);
$cachedData = getCachedData($cacheKey, 'info');
...
// Convert to JSON
$jsonResult = json_encode($resultado, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);

// Cache the result for 15 days
setCachedData($cacheKey, $jsonResult, 'info', 15);
